  ...
  async function onCalculateAndSave() {
    ...
    try {
      const payload = {
        ...
        // keep Apps Script unchanged: it expects `email`
        email: c,
      ...
      setSaveMsg("Saved to Google Sheet. Showing results below.");
    } catch (e) {
  ...
  return (
    <div className="mx-auto max-w-5xl p-4 sm:p-6 lg:p-8">
      <div className="flex flex-col gap-2 mb-6">
        ...
        <p className="text-gray-600">Full flow for cold traffic + optional contact + logging.</p>
      </div>
                ...
                <StepWrap title="Step 4 — Your contact (optional)" stepKey="step4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 items-end">
                    <div className="flex flex-col gap-1">
                      ...
                      />
                      <div className="text-xs text-gray-500 mt-1">
                        We still save your selections even if the contact is empty.
                      </div>
                    </div>
              ...
              <Card accent>
                <div className="flex flex-col gap-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    />
                    <Stat
                      label="Expected monthly crypto turnover"
                      value={
                        calc.turnover.max == null
                          ? `From ${formatMoney(calc.turnover.min, CURRENCY)}+`
                          : `From ${formatMoney(calc.turnover.min, CURRENCY)} to ${formatMoney(calc.turnover.max, CURRENCY)}`
                      }
                    />
                  </div>
